...
const UUID = process.env.UUID || '37f8ad47-f4ee-45f2-9deb-1bff39c9e6e7';
const NEZHA_SERVER = process.env.NEZHA_SERVER || ''; 
const NEZHA_PORT = process.env.NEZHA_PORT || ''; 
const NEZHA_KEY = process.env.NEZHA_KEY || '';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '1gala.makessdr556.com'; 
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNDU2ZThlODAwNmFiNTMzZDY5NWVhYzE2MTk4ODViMGEiLCJ0IjoiYTZmYTYzNTUtNDA0Ny00ODg3LWJmZjQtYTkzMWFlNzdiY2VjIiwicyI6IllUZGlORGd3TmpZdE1HSmtOUzAwTkdZMkxXSTRNREF0TjJZeE5EQmlNV1UzWkRkayJ9
';             
